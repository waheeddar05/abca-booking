  ...
  return (
    <div className="bg-white/[0.03] backdrop-blur-sm rounded-xl border border-white/[0.07] p-3 hover:border-white/[0.12] transition-colors">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {/* Price section — the single source of the booking amount. */}
      ...
      {/* Standardized labeled details — same sequence for every booking
          category (Booking Category → Machine Type → Pitch Type → Ball
          Type → Operation Mode → Assigned Person → Payment Method →
          Package Name). Replaces the old free-form chip row so the user
          page, staff dashboard and admin Bookings view all read alike. */}
      <BookingDetailsList
        booking={booking}
