...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Non-cancelled packages count toward "sold" and session metrics.
    // Revenue nets refunds across ALL statuses — a cancelled package that had
    // partial usage retains its net amount, fully-refunded contributes 0.
