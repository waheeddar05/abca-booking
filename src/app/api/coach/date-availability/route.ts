...
/**
 * Date-range availability for the *current user's own* COACH membership.
 *
 *   GET  /api/coach/date-availability
 *   PUT  /api/coach/date-availability[?preview=true]
 *
 ...
 * reads, so changes are reflected in both surfaces immediately. Mirrors
 * `/api/sidearm/date-availability` exactly.
 */
