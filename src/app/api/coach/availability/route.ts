...
/**
 * Weekly recurring availability for the *current user's own* COACH
 * membership.
 *
 *   GET  /api/coach/availability
 *   PUT  /api/coach/availability[?preview=true]
 *
 ...
 * caller's own COACH membership at the current center, so a coach can only
 * ever edit their own schedule. Writes land in the same
 * MembershipAvailability table the admin tab reads. Mirrors
 * `/api/sidearm/availability` exactly.
 */
