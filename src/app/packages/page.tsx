...
const PACKAGE_MACHINE_CARDS: { id: MachineFilter; label: string; sub: string; category: string; image: string; dot: string }[] = [
  { id: 'GRAVITY', label: 'Gravity Cricket', sub: 'Leather Ball', category: 'LEATHER', image: '/images/leathermachine.jpeg', dot: 'bg-red-500' },
  { id: 'YANTRA', label: 'Yantra Premium', sub: 'Leather Ball', category: 'LEATHER', image: '/images/yantra-machine.jpeg', dot: 'bg-red-500' },
