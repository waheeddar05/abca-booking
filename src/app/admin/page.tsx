...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  // Ledger revenue — recorded by hand rather than generated by a
  // booking. One bucket, so it reads apart from system revenue.
...
// Buckets on the Revenue by Category chart — the booking categories
// plus Manual Revenue (Admin → Ledger). Manual Revenue has no booking
// rows behind it, so it belongs on the revenue chart only, never in
// the Booking Distribution table above.
const REVENUE_CHART_CATEGORIES = [...DASHBOARD_CATEGORIES, 'MANUAL_REVENUE'];
